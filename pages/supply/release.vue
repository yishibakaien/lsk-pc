<template>
	<div class="supplyRelease">
		<header-bar></header-bar>
		<lc-nav></lc-nav>
		<div class="supplyRelease__content wrap">
			<lc-page-title title="发布供应  "></lc-page-title>
			<div class="supplyRelease__content--form">
				<el-form :model="releaseSupplyForm" :rules="rules" ref="releaseSupplyForm" label-width="125px">
					<el-form-item label="花型图片：" class="important">
						<el-input type="file" v-model="releaseSupplyForm.pic"></el-input>
						<!--<lc-file></lc-file>-->
					</el-form-item>
					<el-form-item label="花型分类：" prop="fenlei" class="important">
						<el-radio-group v-model="releaseSupplyForm.fenlei">
					...
					<el-form-item label="大货类型：" prop="dahuo" class="important">
						<el-radio-group v-model="releaseSupplyForm.dahuo">
					...
					<el-form-item label="供应数量：">
						<div style="width: 360px; margin-right: 15px;" class="fl">
							<el-input type="text" v-model="releaseSupplyForm.shuliang"></el-input>
						</div>
					...
					<el-form-item label="供应说明：" prop="shuoming" class="important">
						<el-input type="textarea" :autosize="{ minRows: 4, maxRows: 6}" v-model="releaseSupplyForm.shuoming"></el-input>
					</el-form-item>
					<el-form-item>
						<el-button type="primary" @click="onSubmit">发布供应</el-button>
					</el-form-item>
				</el-form>
			</div>
		</div>
...
<script>
	...
	export default {
		...
		methods: {
			// 选择单位
			handelDropdown(e) {
				this.releaseSupplyForm.danwei = e.value;
				this.danwei = e.name;
			},
			// 发布
			onSubmit() {
